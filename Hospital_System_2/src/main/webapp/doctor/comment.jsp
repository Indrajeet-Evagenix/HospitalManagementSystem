						...
						<form action="../updateStatus" class="row" method="post">
							<div class="col-md-6">
								<label>Patient Name</label><input type="text"
									value="<%=ap.getFullName()%>" readonly class="form-control">
							</div>
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<label>Mobile Number</label><input type="number"
									value="<%=ap.getPhNo()%>" readonly class="form-control">
							</div>
							<div class="col-md-6">
								<label>Diseases</label> <input type="text"
									value="<%=ap.getDiseases()%>" readonly class="form-control">
							</div>
							<div class="col-md-6">
								<label>Comment</label>
